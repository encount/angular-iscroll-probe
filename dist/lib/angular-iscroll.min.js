 ...
 * License: MIT
 */
!function(e,r){"function"==typeof define&&define.amd?define(["iscroll","platform"],r):"object"==typeof exports?module.exports=r(require("./iscroll-probe"),require("platform")):e.angularIscroll=r(e.IScroll,e.platform)}(this,function(h,a){"use strict";e.$inject=["$rootScope","$timeout","$interval","iScrollSignals","iScrollService"];var g={on:"iscroll-on",off:"iscroll-off"},S={},c=angular.isDefined(a)&&function(e){if("Opera Mini"===e.name)return!1;if("IE Mobile"===e.name)return 0<=s(e.version,"11.0");switch(e.os.family){case"Android":return function(e){return"Chrome Mobile"===e.name}(e)||function(e){return 0<=s(e.os.version,"4.0.4")}(e);case"iOS":return 0<=s(e.version,"5.1");default:return!0}}(a);
/**
